...
The entire features included in this dataset are listed below. Description of each feature can be found [here](https://earthquake.usgs.gov/data/comcat/data-eventterms.php#mag).
...
* 
* How to make a heatmap using d3?
